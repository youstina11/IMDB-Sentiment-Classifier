...
> **Setup note:** after you push this repo, replace `YOUR-USERNAME` in the Colab badge URL above with your actual GitHub username so the badge points to your copy of the repo.

## Run in Google Colab

Click the badge above, or open directly:
`https://colab.research.google.com/github/YOUR-USERNAME/imdb-sentiment-classifier/blob/main/notebooks/IMDB_Logistic_Regression.ipynb`
